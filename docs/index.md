...
- Device work demonstrates design that begins with user constraints, manufacturability, and safety boundaries rather than novelty alone.
...
<section id="matrix" class="bento-shell reveal">
  <div class="bento-heading">
    <div>
      ...
      <p class="bento-intro">The grid is weighted toward math modeling as the anchor project, then balanced with device design, infrastructure, and event execution work.</p>
    </div>
  ...
  <div class="bento-grid">
    <article class="bento-card bento-card--modeling bento-card--hero" data-bento-card data-category="computational">
      ...
      <p><a class="bento-card__link" href="projects/disease-treatment-modeling/">Open research showcase</a></p>
    </article>
    ...
    <article class="bento-card bento-card--heart bento-card--wide" data-bento-card data-category="mechanical">
      ...
      <p><a class="bento-card__link" href="projects/heart-smart/">Open device exhibit</a></p>
    </article>
    ...
    <article class="bento-card bento-card--grip" data-bento-card data-category="mechanical leadership">
      ...
      <p><a class="bento-card__link" href="projects/grip-bike-prosthetics/">Open full exhibit</a></p>
    </article>
    ...
    <article class="bento-card bento-card--protease bento-card--wide" data-bento-card data-category="computational">
      <div class="bento-card__meta">Computational | Drug Discovery ML</div>
      <h3 class="bento-card__title">HIV-1 Protease Detector</h3>
      <p class="bento-card__copy">Built an end-to-end screening pipeline that turns SMILES into molecular fingerprints and scores HIV-1 protease inhibition with a PyTorch model trained on 41K+ compounds.</p>
      <div class="bento-card__chips">
        <span>RDKit</span>
        <span>PyTorch</span>
      </div>
    ...
    <article class="bento-card bento-card--hosting bento-card--wide" data-bento-card data-category="leadership mechanical">
      <div class="bento-card__meta">Leadership + Mechanical | Event Hosting</div>
      <h3 class="bento-card__title">HealthHacks &amp; GRiP Designathon</h3>
      <p class="bento-card__copy">Organized build sprints, judging, logistics, and follow-through for recipient-focused design events that turned student teams into real project pipelines.</p>
      <div class="bento-card__chips">
        <span>45 participants</span>
        <span>Cross-university</span>
        <span>Prototype pipeline</span>
      </div>
      <p><a class="bento-card__link" href="leadership/">Open leadership exhibit</a></p>
    </article>
